...
docs/              AUDIT, ARCHITECTURE, DATABASE, API, DEPLOYMENT, SECURITY
```

## Documentation

- [docs/AUDIT.md](docs/AUDIT.md) — what the codebase looked like before this work and why each change was made
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — system design, booking integrity, payment flow, RBAC
