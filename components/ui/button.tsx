...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 ease-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: 'sheen overflow-hidden bg-primary text-primary-foreground shadow-[0_8px_24px_-12px_color-mix(in_oklch,var(--primary)_70%,transparent)] hover:bg-primary/90 hover:shadow-[0_14px_36px_-12px_color-mix(in_oklch,var(--primary)_85%,transparent)]',
        destructive:
          'bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        outline:
          'glass hover:border-primary/40 hover:text-foreground hover:shadow-[0_0_0_1px_color-mix(in_oklch,var(--primary)_30%,transparent)]',
        secondary:
    ...
    compoundVariants: [
      {
        ...
        className: 'active:scale-[0.96] hover:-translate-y-px',
      },
    ],
    defaultVariants: {
      variant: 'default',
